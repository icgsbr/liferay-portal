...
public class ListTypeDefinitionUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		UpgradeProcess upgradeProcess = UpgradeTestUtil.getUpgradeStep(
			...
			"com.liferay.list.type.internal.upgrade.v1_3_2." +
				"ListTypeDefinitionUpgradeProcess");

		long userId = _user.getUserId();

		_userLocalService.deleteUser(_user);

		Assert.assertTrue(_userLocalService.fetchUser(userId) == null);

		Assert.assertTrue(_listTypeDefinition.getUserId() == userId);
